...
export default function GameSettingsSheet({
  ...
  return (
    <div className="ios-settings-backdrop" role="presentation" onClick={onClose}>
      <section className="ios-settings-sheet" role="dialog" aria-modal="true" aria-label="Game settings" onClick={(event) => event.stopPropagation()}>
        ...
        <div className="ios-settings-header">
          ...
          <button className="clean-icon-button ios-settings-close" type="button" onClick={onClose} aria-label="Close settings">
            <AppIcon name="close" />
          </button>
        </div>

        <div className="ios-settings-grid">
          <button className="ios-setting-tile" type="button" onClick={onToggleTheme}>
          ...
          <button className={`ios-setting-tile ${soundEnabled ? 'is-enabled' : ''}`} type="button" onClick={onToggleSound}>
          ...
          <button className={`ios-setting-tile ${musicEnabled ? 'is-enabled' : ''}`} type="button" onClick={onToggleMusic}>
